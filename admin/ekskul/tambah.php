...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $q = mysqli_query($koneksi,
        "INSERT INTO ekstrakurikuler (nama_ekskul, pembina, hari, pukul, deskripsi)
         VALUES ('$nama_ekskul', $pembina_sql, $hari_sql, $pukul_sql, '$deskripsi')");
    if ($q) {
        header("Location: index.php?success=" . urlencode("Ekstrakurikuler '$nama_ekskul' berhasil ditambahkan"));
        exit();
    } else {
...
<div class="main-content">
    ...
    <div class="card">
        <div class="card-header">
            <i class="fas fa-futbol"></i> Form Tambah Ekskul
        </div>
        <div class="card-body">
            <form method="POST">
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" name="nama_ekskul" class="form-control"
                                   placeholder="Contoh: Pramuka, PMR, Futsal" required>
                        </div>
                        <div class="mb-3">
