...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $q = mysqli_query($koneksi,
        "INSERT INTO pelanggaran (siswa_id, jenis_pelanggaran, tingkat_pelanggaran, tanggal, poin, tindakan, petugas)
         VALUES ($siswa_id, '$jenis', '$tingkat', '$tanggal', $poin, '$tindakan', '$petugas')");
    if ($q) {
        header("Location: index.php?success=" . urlencode("Data pelanggaran berhasil ditambahkan"));
        exit();
    } else {
...
<div class="main-content">
    ...
    <div class="page-header">
        <h4><i class="fas fa-exclamation-triangle text-gold me-2"></i>Tambah Pelanggaran</h4>
    </div>
    ...
    <div class="card">
        <div class="card-header">
            <i class="fas fa-exclamation-triangle"></i> Form Tambah Pelanggaran
        </div>
        <div class="card-body">
            <form method="POST">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="jenis_pelanggaran" class="form-control"
                                   placeholder="Contoh: Terlambat masuk, Membawa HP" required>
                        </div>
                        <div class="mb-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" name="poin" class="form-control" min="0" value="0">
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Petugas / Pembina</label>
                            <input type="text" name="petugas" class="form-control"
                                   placeholder="Nama guru BK / petugas">
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Tindakan</label>
                            <textarea name="tindakan" class="form-control" rows="3"
                                      placeholder="Tindakan / pembinaan yang diberikan"></textarea>
                        </div>
                    </div>
                </div>
