...
<tr><td class="label">JENIS KELAMIN</td><td class="titik">:</td><td>' . ((isset($rapor['jenis_kelamin']) && $rapor['jenis_kelamin'] == 'L') ? 'Laki-laki' : 'Perempuan') . '</td><td class="label">Tahun Pelajaran</td><td class="titik">:</td><td>' . e($rapor['tahun_ajaran'] ?? '-') . '</td></tr>
