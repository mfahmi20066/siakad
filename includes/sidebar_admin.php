<div class="sidebar" id="sidebar">
    ...
    <div class="sidebar-menu">
        ...
        <a href="/siakad/admin/guru/index.php"
           class="nav-link <?= strpos($_SERVER['PHP_SELF'], '/admin/guru/') !== false ? 'active' : '' ?>">
            <i class="bi bi-people"></i>
            <span>Data Guru</span>
        </a>

        <a href="/siakad/admin/siswa/index.php"
           class="nav-link <?= strpos($_SERVER['PHP_SELF'], '/admin/siswa/') !== false ? 'active' : '' ?>">
            <i class="bi bi-person-vcard"></i>
            <span>Data Siswa</span>
        </a>

        <a href="/siakad/admin/kelas/index.php"
           class="nav-link <?= strpos($_SERVER['PHP_SELF'], '/kelas/') !== false ? 'active' : '' ?>">
            <i class="bi bi-building"></i>
            <span>Data Kelas</span>
        </a>

        <a href="/siakad/admin/mata_pelajaran/index.php"
           class="nav-link <?= strpos($_SERVER['PHP_SELF'], '/mata_pelajaran/') !== false ? 'active' : '' ?>">
        ...
        <a href="/siakad/admin/jadwal/index.php"
           class="nav-link <?= strpos($_SERVER['PHP_SELF'], '/jadwal/') !== false ? 'active' : '' ?>">
        ...
        <a href="/siakad/admin/rapor/index.php"
           class="nav-link <?= strpos($_SERVER['PHP_SELF'], '/rapor/') !== false ? 'active' : '' ?>">
            <i class="bi bi-file-text"></i>
            <span>Rapor</span>
        </a>

        <div class="menu-label">Kesiswaan</div>

        <a href="/siakad/admin/prestasi/index.php"
           class="nav-link <?= strpos($_SERVER['PHP_SELF'], '/prestasi/') !== false ? 'active' : '' ?>">
            <i class="bi bi-trophy"></i>
            <span>Prestasi</span>
        </a>

        <a href="/siakad/admin/bk/index.php"
           class="nav-link <?= strpos($_SERVER['PHP_SELF'], '/bk/') !== false ? 'active' : '' ?>">
            <i class="bi bi-exclamation-triangle"></i>
            <span>BK / Pelanggaran</span>
        </a>

        <a href="/siakad/admin/ekskul/index.php"
           class="nav-link <?= strpos($_SERVER['PHP_SELF'], '/ekskul/') !== false ? 'active' : '' ?>">
            <i class="bi bi-people-fill"></i>
            <span>Ekstrakurikuler</span>
        </a>

        <div class="menu-label">Penerimaan Siswa Baru</div>
        ...
        <a href="/siakad/admin/spmb/index.php"
           class="nav-link <?= strpos($_SERVER['PHP_SELF'], '/spmb/') !== false ? 'active' : '' ?>">
        ...
        <a href="/siakad/admin/spmb/pendaftar/index.php"
           class="nav-link <?= strpos($_SERVER['PHP_SELF'], '/spmb/pendaftar/') !== false ? 'active' : '' ?>" style="padding-left: 3rem;">
        ...
        <a href="/siakad/admin/beranda/index.php"
           class="nav-link <?= strpos($_SERVER['PHP_SELF'], '/beranda/') !== false ? 'active' : '' ?>">
            <i class="bi bi-house"></i>
            <span>Kelola Beranda</span>
        </a>

        <a href="/siakad/admin/beranda/kelola_berita.php"
           class="nav-link <?= basename($_SERVER['PHP_SELF']) == 'kelola_berita.php' ? 'active' : '' ?>" style="padding-left: 3rem;">
            <i class="bi bi-newspaper"></i>
            <span>Berita & Pengumuman</span>
        </a>

        <a href="/siakad/admin/beranda/kelola_galeri.php"
           class="nav-link <?= basename($_SERVER['PHP_SELF']) == 'kelola_galeri.php' ? 'active' : '' ?>" style="padding-left: 3rem;">
            <i class="bi bi-images"></i>
            <span>Galeri Sekolah</span>
        </a>

        <a href="/siakad/admin/beranda/index.php#struktur"
           class="nav-link" style="padding-left: 3rem;">
        ...
        <a href="/siakad/admin/laporan/index.php"
           class="nav-link <?= strpos($_SERVER['PHP_SELF'], '/laporan/') !== false ? 'active' : '' ?>">
            <i class="bi bi-file-earmark-bar-graph"></i>
            <span>Laporan</span>
        </a>

        <a href="/siakad/admin/tahun_ajaran/index.php"
           class="nav-link <?= strpos($_SERVER['PHP_SELF'], '/tahun_ajaran/') !== false ? 'active' : '' ?>">
        ...
        <a href="/siakad/admin/verifikasi_akun/index.php"
           class="nav-link <?= strpos($_SERVER['PHP_SELF'], '/verifikasi_akun/') !== false ? 'active' : '' ?>">
        ...
        <a href="/siakad/admin/pengaturan.php"
           class="nav-link <?= basename($_SERVER['PHP_SELF']) == 'pengaturan.php' ? 'active' : '' ?>">
